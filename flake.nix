  ...
  outputs = { self, nixpkgs, flake-utils, poetry2nix }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        ohtuvarasto = { poetry2nix, lib }: poetry2nix.mkPoetryApplication {
          projectDir = self;
        ...
        pkgs = import nixpkgs {
          ...
          overlays = [
            ...
            (final: _: {
              ohtuvarasto = final.callPackage ohtuvarasto { };
            })
          ];
        };
      in
      {
        packages.default = pkgs.ohtuvarasto;
        devShells = {
